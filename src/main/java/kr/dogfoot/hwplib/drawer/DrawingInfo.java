...
public class DrawingInfo {
    ...
    private boolean bodyTextParagraph;
    ...
    public void startParagraph(Paragraph paragraph, boolean bodyTextParagraph) {
        ...
        this.bodyTextParagraph = bodyTextParagraph;
        setParagraphArea();
    }

    private void setParagraphArea() {
        if (bodyTextParagraph) {
            paragraphArea = new Area(pageMaker.pageArea())
    ...
    public Area paperArea() {
        return pageMaker.paperArea();
    }

    public Area pageArea() {
        return pageMaker.pageArea();
    }
