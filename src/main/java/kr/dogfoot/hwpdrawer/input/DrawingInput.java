package kr.dogfoot.hwpdrawer.input;

import kr.dogfoot.hwpdrawer.input.paralist.ParagraphListInfo;
import kr.dogfoot.hwpdrawer.input.paralist.ParallelMultiColumnInfo;
...
public class DrawingInput {
    ...
    public void startCellParaList(Area textBoxArea, ParagraphListInterface paraList, boolean canDivide, long topInPage, long bottomMargin, boolean divided, int startTextColumnIndex) {
        ParagraphListInfo paraListInfo = new ParagraphListInfo(this, paraList)
                .forCell(textBoxArea, canDivide, topInPage, bottomMargin, divided, startTextColumnIndex);
        paraListInfoStack.push(paraListInfo);
    }
    ...
    public LineSegItem currentLineSeg() {
        return currentParaListInfo().currentLineSeg();
    }

    public LineSegItem previousLineSeg() {
        return currentParaListInfo().previousLineSeg();
    }

    public LineSegItem nextLineSeg() {
        return currentParaListInfo().nextLineSeg();
    }

    public void moveNextLineSeg() {
        currentParaListInfo().moveNextLineSeg();
    }
    ...
    public boolean firstLine() {
        return currentParaListInfo().lineSegIndex() == 0;
    }
