...
import kr.dogfoot.hwpdrawer.drawer.para.nolineseg.CharInfoBuffer;
...
public class CharAdder {
    ...
    public CharAdder(DrawingInput input, InterimOutput output, ParaDrawerWithLineSeg paraDrawer, TextLineDrawer textLineDrawer) {
        this.input = input;
        this.output = output;
    ...
    private void controlChar(HWPCharControlChar ch) {
