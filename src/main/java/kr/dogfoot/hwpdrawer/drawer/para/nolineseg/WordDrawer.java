...
import kr.dogfoot.hwpdrawer.drawer.control.ControlDrawer;
...
public class WordDrawer {
    ...
    public WordDrawer(DrawingInput input, InterimOutput output, ParaDrawerWithoutLineSeg paraDrawer, TextLineDrawer textLineDrawer, TextFlowCalculator textFlowCalculator) {
        this.input = input;
        this.output = output;
