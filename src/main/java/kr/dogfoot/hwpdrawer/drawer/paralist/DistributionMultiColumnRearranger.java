...
import kr.dogfoot.hwpdrawer.output.text.TextColumn;
...
public class DistributionMultiColumnRearranger {
    ...
    public DistributionMultiColumnRearranger(DrawingInput input, InterimOutput output, ParaListDrawer paraListDrawer, ParaDrawerWithoutLineSeg paraDrawer) {
        this.input = input;
        this.output = output;
