package kr.dogfoot.hwpdrawer.para_char;
...
public class ParagraphTest {
    ...
    @Test
    public void test_문단모양_위아래여백_1() throws Exception {
        HWPTester.testAndCompare("testingHWP" + File.separator + "문단모양" + File.separator + "위아래여백" + File.separator + "1");
    }

    @Test
    public void test_문단모양_위아래여백_2() throws Exception {
        HWPTester.testAndCompare("testingHWP" + File.separator + "문단모양" + File.separator + "위아래여백" + File.separator + "2");
    }

    @Test
    public void test_문단모양_위아래여백_3() throws Exception {
        HWPTester.testAndCompare("testingHWP" + File.separator + "문단모양" + File.separator + "위아래여백" + File.separator + "3");
    }
}
